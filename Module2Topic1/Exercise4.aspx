...
<body>
    ...
    <form runat="server">
        ...
        <asp:RequiredFieldValidator ID="requiredName" runat="server" ControlToValidate="fullName" ErrorMessage="This field is required." />
        <br />
        ...
        <asp:RangeValidator ID="ageRange" runat="server" ControlToValidate="age" ErrorMessage="Age must be between 0 and 100." MinimumValue="0" MaximumValue="100" Type="Integer" />
        <br />
        ...
        <asp:RegularExpressionValidator ID="emailRegex" runat="server" ControlToValidate="email" ErrorMessage="Invalid email." ValidationExpression="^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$" />
        <br />
        ...
        <asp:CompareValidator ID="emailCompare" runat="server" ControlToValidate="confirmEmail" ControlToCompare="email" ErrorMessage="Emails do not match." />
        <br /> 
